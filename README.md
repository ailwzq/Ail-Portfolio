...
Run `npm run build` to check the site before publishing. Push the folder to GitHub, import the repository at [vercel.com/new](https://vercel.com/new), and accept Vercel’s detected Next.js settings.
